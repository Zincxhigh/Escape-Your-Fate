...
effect give @a[tag=tank] speed 1 3 true
effect give @a[tag=tank] absorption 1 6 true
...
effect give @a[tag=is_monster] speed 1 4 true
effect give @a[tag=is_monster] night_vision 100 7 true
effect give @a[tag=is_monster] strength 1 10 true
...
# 4. BORDERS
execute as @a[tag=tank,distance=500..] run tp @s 263 80 -320
execute as @a[tag=monster_detecter,distance=500..] run tp @s 263 80 -320
execute as @a[tag=reviver,distance=500..] run tp @s 263 80 -320
execute as @a[tag=is_monster,distance=500..] run tp @s 218 88 -272
