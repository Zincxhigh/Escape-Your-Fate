...
title @a[tag=is_monster] title {"text":"You are KEVIN","color":"red","bold": true}
title @a[tag=is_monster] actionbar {"text":"HINT=> {%^&$^^$kILL^%^I WANNA KILL}","bold": true,"color": "red"}
title @a[tag=tank] title {"text":"You are LEON","color":"white","bold": true}
title @a[tag=tank] actionbar {"text":"HINT=> Your way stronger and faster You know that right?","bold": true,"color": "white"}
title @a[tag=reviver] title {"text":"You are ZACH","bold": true,"color": "green"}
title @a[tag=reviver] actionbar {"text":"HINT=> You can help them walk again","bold": true,"color": "green"}
title @a[tag=monster_detecter] title {"text":"You are MARIO","color":"blue","bold": true}
title @a[tag=monster_detecter] actionbar {"text":"HINT=> You can sense unusual things near you","bold": true,"color": "blue"}
...
give @a[tag=is_monster] minecraft:diamond_sword
give @a[tag=is_monster] minecraft:potion[minecraft:potion_contents={custom_effects:[{id:"minecraft:invisibility",amplifier:1,duration:1000}]}]
give @a[tag=is_monster] minecraft:potion[minecraft:potion_contents={custom_effects:[{id:"minecraft:invisibility",amplifier:1,duration:1000}]}]
give @a[tag=is_monster] minecraft:potion[minecraft:potion_contents={custom_effects:[{id:"minecraft:invisibility",amplifier:1,duration:1000}]}]
give @a[tag=is_monster] minecraft:potion[minecraft:potion_contents={custom_effects:[{id:"minecraft:invisibility",amplifier:1,duration:1000}]}]
