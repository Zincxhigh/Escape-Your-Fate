...
execute as @a[x=-37,y=-2,z=37,distance=..5,tag=!played_once] at @s run playsound minecraft:creepy master @s -37 -2 37
tag @a[x=-37,y=-2,z=37,distance=..5,tag=!played_once] add played_once

execute as @a[x=-1,y=-2,z=24,distance=..5,tag=!played_twice] at @s run playsound minecraft:drum master @s -1 -2 24
tag @a[x=-1,y=-2,z=24,distance=..5,tag=!played_twice] add played_twice

execute as @a[x=-32,y=-2,z=17,distance=..5,tag=!played_three] at @s run playsound minecraft:drum master @s -32 -2 17 1 0.5
tag @a[x=-32,y=-2,z=17,distance=..5,tag=!played_three] add played_three

execute as @a[x=-10,y=4,z=11,distance=..5,tag=!played_four] at @s run playsound minecraft:creepy master @s -10 4 11 1 0.5
tag @a[x=-10,y=4,z=11,distance=..5,tag=!played_four] add played_four

execute as @a[x=-39,y=4,z=23,distance=..5,tag=!played_five] at @s run playsound minecraft:terror master @s -39 4 23 1
