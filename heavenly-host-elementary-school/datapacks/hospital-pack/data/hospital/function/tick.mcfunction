...
# 4. BORDERS
execute as @a[tag=tank,x=3,z=3,distance=50..] run tp @s -51 -3 52
execute as @a[tag=monster_detecter,x=3,z=3,distance=50..] run tp @s -51 -3 52
execute as @a[tag=reviver,x=3,z=3,distance=50..] run tp @s -51 -3 52
execute as @a[tag=is_monster,x=3,z=3,distance=80..] run tp @s -2 -2 -43
